...
def main():
    ...
    # for atom in periodic_table_dict:
    #     print(f"{atom['name']}: {atom['mass']} amu")
    known_molecules_dict = make_molecules_dict()
    # Get a chemical formula for a molecule from the user.
    formula = input('Please enter a molecular formula: ')
    molecule_name = get_formula_name(formula, known_molecules_dict)
    print(molecule_name)
    # Get the mass of a chemical sample in grams from the user.
    molecular_mass = float(input('Please enter the mass of a sample (g): '))
    ...
    num_moles = molecular_mass / molar_mass
    # Print the molar mass.
    print(f'Molar mass: {molar_mass}')
    # Print the number of moles.
    print(f'{num_moles} moles in sample')
